...
NSIMVIEW
{
CAMERAPOSITION=6.467112,6.665257,8.315282;
CAMERATARGET=-1.609521,-1.411374,0.238650;
CAMERAUPVECTOR=-0.408248,-0.408248,0.816497;
CAMERAFIELD=5.595171,5.595171;
USERVIEW
	{
	NO=0
	NAME=
...
MODEL
	{
	NAME=02-01-23 malben_table_-1995_-225_780;
	PARENT=worldframe;
...
MODEL
	{
	NAME=DX200-18-12-cube1;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube1.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=0;
	OPACITY=0.50;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube2;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube2.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=1;
	OPACITY=0.05;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube3;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube3.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=1;
	OPACITY=0.02;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube4;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube4.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=1;
	OPACITY=0.02;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube5;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube5.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=1;
	OPACITY=0.02;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube6;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube6.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=1;
	OPACITY=0.02;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube7;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube7.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=0;
	OPACITY=0.50;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube8;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube8.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=0;
	OPACITY=0.50;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube9;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube9.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=1;
	OPACITY=0.10;
	SCALE=1.000000;
...
MODEL
	{
	NAME=DX200-18-12-cube10;
	PARENT=DX200-18-12-R01;
	FILENAME=%CELPATH%\models\DX200-18-12-cube10.mdl;
	COLOR=RGB(0,0,255);
	HIDESEE=0;
	OPACITY=0.10;
	SCALE=1.000000;
